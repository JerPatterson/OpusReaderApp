...
object HeadsignRegistry {
    ...
    private val headsignMapForSTL: Map<UInt, Map<UInt, String>> = mapOf(
        ...
        155u to mapOf(1u to "Station Sainte-Dorothée", 2u to "Métro Montmorency"),
    ...
    private val headsignMapForExoSorelVarennes: Map<UInt, Map<UInt, String>> = mapOf(
        18u to mapOf(1u to "Termins Sainte-Julie", 2u to "Termins Sainte-Julie"),
    ...
    private val headsignMapForExoSainteJulie: Map<UInt, Map<UInt, String>> = mapOf(
        14u to mapOf(1u to "Sainte-Julie", 2u to "Terminus Longueuil"),
        15u to mapOf(1u to "Sainte-Julie", 2u to "Longueuil"),
        16u to mapOf(1u to "Sainte-Julie", 2u to "Terminus Longueuil"),
        4u to mapOf(1u to "Sainte-Julie", 2u to "Terminus Longueuil"),
        9u to mapOf(1u to "Sainte-Julie", 2u to "Terminus Brossard"),
    )
    ...
    private val headsignMapForExoChamblyRichelieuCarignan: Map<UInt, Map<UInt, String>> = mapOf(
        ...
        50u to mapOf(1u to "Chambly - Franquet", 2u to "Terminus Brossard"),
        51u to mapOf(1u to "Faubourg Carignan", 2u to "Terminus Brossard"),
        52u to mapOf(1u to "Île aux Lièvres", 2u to "Terminus Brossard"),
        53u to mapOf(1u to "Chambly - Bourgogne", 2u to "Terminus Brossard"),
        54u to mapOf(1u to "Marieville", 2u to "Terminus Brossard"),
        55u to mapOf(1u to "Chambly - Industriel", 2u to "Terminus Brossard"),
        56u to mapOf(1u to "Chambly - Daigneault", 2u to "Terminus Brossard"),
    ...
    private val headsignMapForExoLeRichelain: Map<UInt, Map<UInt, String>> = mapOf(
        63u to mapOf(1u to "Terminus Brossard", 2u to "La Prairie - Magdelaine"),
        64u to mapOf(1u to "Terminus Brossard", 2u to "La Prairie - Briqueterie"),
        65u to mapOf(1u to "Terminus Brossard", 2u to "La Prairie"),
        66u to mapOf(1u to "Terminus Panama", 2u to "Vieux-La Prairie"),
        67u to mapOf(1u to "Terminus Brossard", 2u to "Candiac - Charlemagne"),
        68u to mapOf(1u to "Terminus Brossard", 2u to "Candiac - Deauville"),
        69u to mapOf(1u to "Terminus Brossard", 2u to "Candiac - Fouquet"),
    ...
    private val headsignMapForExoSudOuest: Map<UInt, Map<UInt, String>> = mapOf(
        ...
        2u to mapOf(1u to "Maple Grove", 2u to "Melocheville"),
        3u to mapOf(1u to "Terminus Angrignon", 2u to "Terminus Châteauguay"),
        4u to mapOf(1u to "Terminus Châteauguay", 2u to "Terminus Châteauguay"),
    ...
    private val headsignMapForExoLaurentides: Map<UInt, Map<UInt, String>> = mapOf(
        172u to mapOf(2u to "Station Deux-Montagnes"),
        173u to mapOf(2u to "Station Deux-Montagnes"),
        174u to mapOf(2u to "Station Deux-Montagnes"),
        175u to mapOf(2u to "Station Deux-Montagnes"),
        176u to mapOf(1u to "Station Deux-Montagnes"),
        177u to mapOf(2u to "Station Deux-Montagnes"),
        178u to mapOf(1u to "Station Deux-Montagnes"),
        153u to mapOf(1u to "Carrefour du Nord", 2u to "SmartCentre Saint-Jérôme"),
        154u to mapOf(2u to "Terminus Saint-Jérôme"),
        ...
        160u to mapOf(2u to "Terminus Saint-Jérôme"),
        161u to mapOf(2u to "Terminus Saint-Jérôme"),
        162u to mapOf(1u to "Terminus Saint-Jérôme"),
        179u to mapOf(2u to "Terminus Sainte-Thérèse"),
    ...
    private val headsignMapForExoPresquIle: Map<UInt, Map<UInt, String>> = mapOf(
        ...
        33u to mapOf(1u to "Terminus Vaudreuil", 2u to "Terminus Vaudreuil"),
        34u to mapOf(1u to "Terminus Vaudreuil"),
        35u to mapOf(2u to "Terminus Vaudreuil"),
        36u to mapOf(1u to "Gare Dorion"),
        37u to mapOf(1u to "Gare Île-Perrot", 2u to "Point-aux-Renards"),
        38u to mapOf(1u to "Gare Île-Perrot", 2u to "Gare Île-Perrot"),
        ...
        45u to mapOf(1u to "Terminus Vaudreuil", 2u to "Terminus Vaudreuil"),
    ...
    private val headsignMapForExoTerrebonneMascouche: Map<UInt, Map<UInt, String>> = mapOf(
        ...
        22u to mapOf(1u to "Terrebonne", 2u to "Terminus Terrebonne"),
        ...
        35u to mapOf(1u to "Cité du sport", 2 to "Lachenaie"),
        9u to mapOf(1u to "Terminus Terrebonne", 2u to "Forum de La Plaine"),
        12u to mapOf(1u to "La Plaine", 2u to "Terminus Terrebonne"),
        13u to mapOf(1u to "Terminus Terrebonne", 2u to "Terminus Terrebonne"),
        14u to mapOf(1u to "Terminus Montmorency", 2u to "Terminus Terrebonne"),
        15u to mapOf(1u to "Mascouche", 2u to "Terminus Terrebonne"),
        16u to mapOf(1u to "Terminus Terrebonne"),
        23u to mapOf(1u to "Cité du sport", 2u to "Mascouche"),
        ...
        36u to mapOf(1u to "Cité du sport", 2u to "Terminus Terrebonne"),
        21u to mapOf(1u to "Terminus Radisson", 2u to "Lachenaie"),
        43u to mapOf(1u to "Terminus Radisson", 2u to "Lachenaie"),
        46u to mapOf(1u to "Gare Mascouche", 2u to "La Plaine"),
    ...
    private val headsignMapForExoLassomption: Map<UInt, Map<UInt, String>> = mapOf(
        ...
        2u to mapOf(1u to "Saint-Sulpice", 2u to "Repentigny"),
