    ...
    companion object {
        fun getFareProductById(context: Context, operatorId: UInt, id: UInt): FareProduct {
            return when (id) {
                ...
                FareProductId.OPUS_MONTHLY_TRAM4.id -> FareProduct("Mensuel, TRAM 4", R.string.old_fare_info)
                FareProductId.OPUS_MONTHLY_TRAM4_STU.id -> FareProduct("Mensuel, TRAM 4", R.string.old_fare_info)
                FareProductId.OPUS_MONTHLY_TRAM4_RED.id -> FareProduct("Mensuel, TRAM 4", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAM4.id -> FareProduct("Abonnement, TRAM 4", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAM4_STU.id -> FareProduct("Abonnement, TRAM 4", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAM4_RED.id -> FareProduct("Abonnement, TRAM 4", R.string.old_fare_info)
                ...
                FareProductId.OPUS_6TICKETS_TRAIN4.id -> FareProduct("6 passages, TRAIN 4", R.string.old_fare_info)
                FareProductId.OPUS_6TICKETS_TRAIN4_RED.id -> FareProduct("6 passages, TRAIN 4", R.string.old_fare_info)
                FareProductId.OPUS_MONTHLY_TRAIN4.id -> FareProduct("Mensuel, TRAIN 4", R.string.old_fare_info)
                FareProductId.OPUS_MONTHLY_TRAIN4_STU.id -> FareProduct("Mensuel, TRAIN 4", R.string.old_fare_info)
                FareProductId.OPUS_MONTHLY_TRAIN4_RED.id -> FareProduct("Mensuel, TRAIN 4", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAIN4.id -> FareProduct("Abonnement, TRAIN 4", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAIN4_STU.id -> FareProduct("Abonnement, TRAIN 4", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAIN4_RED.id -> FareProduct("Abonnement, TRAIN 4", R.string.old_fare_info)
                ...
                FareProductId.OPUS_MONTHLY_TRAIN5.id -> FareProduct("Mensuel, TRAIN 5", R.string.old_fare_info)
                FareProductId.OPUS_MONTHLY_TRAIN5_STU.id -> FareProduct("Mensuel, TRAIN 5", R.string.old_fare_info)
                FareProductId.OPUS_MONTHLY_TRAIN5_RED.id -> FareProduct("Mensuel, TRAIN 5", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAIN5.id -> FareProduct("Abonnement, TRAIN 5", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAIN5_STU.id -> FareProduct("Abonnement, TRAIN 5", R.string.old_fare_info)
                FareProductId.OPUS_YEARLY_TRAIN5_RED.id -> FareProduct("Abonnement, TRAIN 5", R.string.old_fare_info)
                ...
                FareProductId.OPUS_MONTHLY_TRAIN3_SPECIAL_LULA.id -> FareProduct("Mensuel, TRAIN 3", R.string.train_lula_monthly_info)
                FareProductId.OPUS_MONTHLY_TRAIN3_SPECIAL_LULA_RED.id -> FareProduct("Mensuel, TRAIN 3", R.string.train_lula_monthly_info)
                FareProductId.OPUS_MONTHLY_TRAIN4_SPECIAL_LULA.id -> FareProduct("Mensuel, TRAIN 4", R.string.train_lula_monthly_info)
                FareProductId.OPUS_MONTHLY_TRAIN4_SPECIAL_LULA_RED.id -> FareProduct("Mensuel, TRAIN 4", R.string.train_lula_monthly_info)
                FareProductId.OPUS_MONTHLY_TRAIN5_SPECIAL_LULA.id -> FareProduct("Mensuel, TRAIN 5", R.string.train_lula_monthly_info)
                FareProductId.OPUS_MONTHLY_TRAIN5_SPECIAL_LULA_RED.id -> FareProduct("Mensuel, TRAIN 5", R.string.train_lula_monthly_info)
                ...
                FareProductId.OCC_6TICKETS_TRAIN4.id -> FareProduct("6 passages, TRAIN 4", R.string.old_fare_info)
