    ...
    companion object {
        ...
        private fun getSTMLineById(context: Context, operatorId: UInt, id: UInt): Line {
            ...
            return when (id) {
                ...
                14u -> Line("19", "Chabanel / Marché Central", "#009ee0", "#ffffff", R.drawable.bus)
                ...
                76u -> Line("106", "Newman", "#009ee0", "#ffffff", R.drawable.bus)
                77u -> Line("107", "Verdun", "#009ee0", "#ffffff", R.drawable.bus)
                ...
                81u -> Line("112", "Airlie", "#009ee0", "#ffffff", R.drawable.bus)
                ...
                237u -> Line("405", "Express Bord-du-Lac", "#009ee0", "#ffffff", R.drawable.bus)
                261u -> Line("406", "Express Newman", "#781b7d", "#ffffff", R.drawable.bus)
                ...
                512u -> Line("21", "Place du Commerce", "#009ee0", "#ffffff", R.drawable.bus)
                513u -> Line("22", "Notre-Dame", "#009ee0", "#ffffff", R.drawable.bus)
                514u -> Line("35", "Griffintown", "#009ee0", "#ffffff", R.drawable.bus)
                515u -> Line("36", "Monk", "#009ee0", "#ffffff", R.drawable.bus)
                516u -> Line("38", "De l'Église", "#009ee0", "#ffffff", R.drawable.bus)
                517u -> Line("50", "Vieux-Montréal / Vieux-Port", "#009ee0", "#ffffff", R.drawable.bus)
                518u -> Line("71", "Du Centre", "#009ee0", "#ffffff", R.drawable.bus)
                519u -> Line("81", "Saint-Jean-Baptiste", "#009ee0", "#ffffff", R.drawable.bus)
                520u -> Line("114", "Angrignon", "#009ee0", "#ffffff", R.drawable.bus)
                521u -> Line("135", "De l'Esplanade", "#009ee0", "#ffffff", R.drawable.bus)
                522u -> Line("172", "Du Golf", "#009ee0", "#ffffff", R.drawable.bus)
                523u -> Line("178", "Pointe-Nord / Île-des-Soeurs", "#009ee0", "#ffffff", R.drawable.bus)
                524u -> Line("190", "Norman", "#009ee0", "#ffffff", R.drawable.bus)
                525u -> Line("188", "Broadway", "#009ee0", "#ffffff", R.drawable.bus)
                526u -> Line("212", "Sainte-Anne", "#009ee0", "#ffffff", R.drawable.bus)
        ...
        private fun getEXOLaurentidesLineById(context: Context, operatorId: UInt, id: UInt): Line {
            ...
            return when (id) {
                ...
                512u -> Line("8", "Saint-Eustache - Laval (métro Montmorency)", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                513u -> Line("12", "Direction Bois-des-Filion", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                514u -> Line("15", "Rosemère - Gare Rosemère", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                515u -> Line("17", "Terrebonne - Gare Rosemère", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                516u -> Line("20", "Terrebonne ouest - Gare Rosemère", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                517u -> Line("22", "Bois-des-Filion - Sainte-Thérèse", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                518u -> Line("23", "Sainte-Anne-des-Plaines - Sainte-Thérèse", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                519u -> Line("24", "Sainte-Anne-des-Plaines - Laval (métro Cartier)", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                520u -> Line("27", "Lorraine - Sainte-Thérèse", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                521u -> Line("28", "Terrebonne - Laval (métro Cartier)", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                522u -> Line("52", "Boisbriand Sud vers Boisbriand Nord", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                523u -> Line("59", "Boisbriand - Laval (métro Montmorency)", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                524u -> Line("60", "Sainte-Thérèse", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                525u -> Line("61", "Sainte-Thérèse - secteur Bas Sainte-Thérèse", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                526u -> Line("62", "Sainte-Thérèse - secteur des Mille-Îles", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                ...
                531u -> Line("80", "Saint-Eustache - Pointe-Calumet", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                532u -> Line("81", "Saint-Eustache - Pointe-Calumet", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                533u -> Line("89", "Saint-Eustache - secteur Dubois", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                534u -> Line("90", "Saint-Eustache - Arthur-Sauvé et Industriel", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                535u -> Line("91", "Saint-Eustache - secteur est (Saint-Laurent)", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                536u -> Line("92", "Saint-Eustache - secteur centre", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                537u -> Line("93", "Saint-Eustache - Deux-Montagnes", "#1F1F1F", "#FFFFFF", R.drawable.bus)
        ...
        private fun getEXOTerrebonneMascoucheLineById(context: Context, operatorId: UInt, id: UInt): Line {
            ...
            return when (id) {
                ...
                512u -> Line("1", "Terrebonne - Mascouche", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                513u -> Line("2", "Terrebonne - Mascouche", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                514u -> Line("3", "Terrebonne - Mascouche", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                515u -> Line("4", "Terrebonne - Mascouche", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                516u -> Line("5", "Terrebonne - Bois-des-Filion", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                517u -> Line("8", "Terrebonne - secteur centre", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                518u -> Line("9", "Terrebonne - secteur ouest", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                519u -> Line("11", "Terrebonne - Lachenaie", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                520u -> Line("11C", "Terrebonne - Cité du sport - Lachenaie", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                521u -> Line("14", "Terrebonne - La Plaine", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                522u -> Line("17", "Terrebonne - La Plaine", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                523u -> Line("18", "Terrebonne - Cité du sport - Cégep de Terrebonne", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                524u -> Line("20", "Terrebonne - Mascouche", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                525u -> Line("21", "Terrebonne - Mascouche", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                526u -> Line("22", "Mascouche - Cité du sport - Cégep de Terrebonne", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                527u -> Line("23", "Terrebonne - Sainte-Thérèse (Cégep Lionel-Groulx)", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                528u -> Line("24C", "Terrebonne - Cité du sport - Cégep de Terrebonne", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                529u -> Line("25", "Terrebonne - Montréal", "#1F1F1F", "#FFFFFF", R.drawable.bus)
                ...
                533u -> Line("40", "Lachenaie - Montréal - Terminus Radisson", "#1F1F1F", "#FFFFFF", R.drawable.bus)
        ...
        private fun getSTLevisLineById(context: Context, operatorId: UInt, id: UInt): Line {
            ...
            return when (id) {
                ...
                570u -> Line("L2", "Lévisien 2", "#1E4289", "#FFFFFF", R.drawable.bus)
                571u -> Line("L3,", "Lévisien 3", "#1E4289", "#FFFFFF", R.drawable.bus)
